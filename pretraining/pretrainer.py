...
for step in list(range(pretrain_steps)):
    ...
    if i % pretrain_eval_steps == 0 and i != 0:
        ...
        for eval_set in eval_sets:
            ...
            torch.save(model.state_dict(), "/home/ext/konle/diss/eval_drama_checkpoint_"+str(step)+".pt")
        ...
        if len(cls_eval_sets) > 0:
            ...
            torch.save(model.state_dict(), "/home/ext/konle/diss/eval_drama_checkpoint_"+str(step)+".pt")
            torch.save(pre_optimizer.state_dict(), "/home/ext/konle/diss/drama_optimizer.pt")
            torch.save(pre_scheduler.state_dict(), "/home/ext/konle/diss/drama_scheduler.pt")
            model.to("cpu")
            ...
            for eval_set in cls_eval_sets:
                ...
                model = load_checkpoint_cls(model_name, "/home/ext/konle/diss/eval_drama_checkpoint_"+str(step)+".pt")
